...
## Variables audited
  beta, chi2pid, ftof_energy_1A, ftof_energy_1B, ftof_time_1A, ftof_time_1B, ftof_path_1A, ftof_path_1B, ecin_energy, ecout_energy, ecin_time, ecout_time, ecin_path, ecout_path, nphe_htcc, nphe_ltcc, pcal_energy, pcal_time, pcal_path, ftof_energy_2, ftof_time_2, ftof_path_2, p, theta, phi, vz, sector
