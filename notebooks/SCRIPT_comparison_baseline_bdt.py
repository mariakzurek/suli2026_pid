...
csvFile = "../figures/full_range/optimized_thresholdsV4.csv"
...
outpath = Path(
    "../figures/full_range/efficiency_BDT_vs_chi2pid.png"
)
...
# Save
outpath = Path(
    "../figures/full_range/contamination_BDT_vs_chi2pid.png"
)
