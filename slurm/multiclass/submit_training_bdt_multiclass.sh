#!/bin/bash
# =============================================================================
# submit_training_bdt_multiclass.sh — Submit the BDT training job as a single SLURM job.
#
...
WORKER_SCRIPT="${SCRIPT_DIR}/_training_bdt_job_multiclass.sh"
...
SBATCH_CMD=(
    sbatch
    --job-name=training_bdt_multiclass
    --account=clas12
    --time="${JOB_TIME}"
    --mem="${JOB_MEM}"
